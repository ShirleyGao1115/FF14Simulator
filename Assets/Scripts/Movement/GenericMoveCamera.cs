...
namespace Simulator.Movement {
    public class GenericMoveCamera {
        public GenericMoveInputs inputs = App.Instance?.MoveInputs;
        ...
        public void Initialize(GameObject aMainPlayer)
        {
            ...
            inputs.onCameraZooming += onZooming;
            inputs.onCameraUpDown += onCameraUpDown;
        }
        ...
        //     // if (GetInputs.isPlayerMove)
        //     // {
        //     //     Vector3 position = this.transform.position + GetInputs.playerMoveDirection * CharacterTarget.MoveSpeed;
